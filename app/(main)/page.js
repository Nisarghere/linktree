        ...
        <section className='bg-yellow-300 min-h-[100vh] grid grid-cols-1 md:grid-cols-2 md:w-full'>
          ...
          <div className='flex flex-col justify-center px-6 md:ml-[10vw] gap-4 md:pt-15 pt-28 md:w-full'>
            ...
            <div className='flex flex-col sm:flex-row gap-2'>
              ...
              <button
                onClick={() => createtree()}
                className='px-6 py-4 bg-[#254F1A] transition-transform hover:-translate-y-0.5 duration-150 hover:bg-red-900 cursor-pointer rounded-full font-semibold text-white w-full sm:w-auto'
              >
                Claim your tree
              </button>
            </div>
